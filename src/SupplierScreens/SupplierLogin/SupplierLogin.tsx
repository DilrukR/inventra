...
import {supplierLogin} from '../../redux/slices/authSlice';
import {useNavigation} from '@react-navigation/native';
type Props = {};

const SupplierLogin = (props: Props) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      await dispatch(supplierLogin({email, password})).unwrap();
      navigation.navigate('SupplierTabNav');
    } catch (err) {
      setLoading(false);
